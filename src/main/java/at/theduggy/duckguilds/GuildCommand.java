                                    ...
                                    if (!args[3].equals("")) {
                                        if (!args[4].equals("") && allColorsForColorAndDark.contains(args[4])) {
                                            ...
                                            try {
                                                ...
                                                tag = args[3];
                                                tagColor = args[4];
                                                GuildCreate.createGuild((Player) player, Utils.translateFromReadableStringToChatColorLightColors(color), name, tag, Utils.translateFromReadableStringToChatColorAllColors(tagColor));
                    ...
                    case "delete":
                        switch (args.length){
                            case 2:
                                ...
                                if (Utils.isPlayerInGuild((Player) player)) {
                                    if (Utils.getIfPlayerIsHeadOfGuild(Utils.getPlayerGuild((Player) player), (Player) player)) {
                                        guilds.add(Utils.getPlayerGuild((Player) player));
                                    }
